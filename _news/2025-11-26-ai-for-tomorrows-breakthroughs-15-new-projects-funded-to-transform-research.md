---
layout: news-single
title: "AI for Tomorrow's Breakthroughs: 15 New Projects Funded to Transform Research"
excerpt: >-
  The Accelerate Programme for Scientific Discovery and the Cambridge Centre for
  Data-Driven Discovery (C2D3) are proud to announce funding for 15
  groundbreaking projects that will use artificial intelligence to tackle some
...
date: 2025-11-27T00:00:15+00:00
image: /assets/uploads/accelerate-c2d3-2025-funding-call-announcement.png
---
The Accelerate Programme for Scientific Discovery and the [Cambridge Centre for Data-Driven Discovery (C2D3)](https://www.c2d3.cam.ac.uk/) are proud to announce funding for 15 groundbreaking projects that will use artificial intelligence to tackle some of the most pressing challenges in science and society.
...
* **Dr Boris Bolliet** (Department of Physics) is developing his model for automating data analysis with LLM agents into a robust platform providing users with personalised research environments integrated with AI agents, in collaboration with partners at Google DeepMind and the Flatiron Institute.
* **Dr Anna Breger** (Department of Applied Mathematics and Theoretical Physics) is developing an open software toolbox to allow wider uptake of machine learning algorithms for reconstructing degraded historical sheet music.
* **Charles Emogor and Anil Madhavapeddy** (Departments of Zoology and Computer Science and Technology) are working with rangers in protected areas to develop and validate AI models that predict illegal hunting activity and optimise anti-poaching patrol routes.
* **Megan Ennion and Steve Watson** (Faculty of Education) are delivering events to create opportunities for dialogue, knowledge exchange, and interdisciplinary collaboration on AI in Education.
* **Maya Juman and Olivier Restif** (Department of Veterinary Medicine) are applying their AI framework for studying RNA viruses in fruit bats to coronaviruses, contributing towards pharmaceutical innovation.
* **Dr Mairead Healy** (Department of Psychology) is advancing the diagnosis and treatment of OCD by validating a machine learning model with real UK clinical populations and launching an accessible clinical tool.
